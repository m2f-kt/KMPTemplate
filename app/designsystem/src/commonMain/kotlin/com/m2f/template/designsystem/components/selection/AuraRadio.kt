...
/**
 * An Aura-styled radio button component with accessibility support.
 *
...
private fun AuraRadioPreview() {
    AuraTheme {
        Column(
            ...
            AuraRadio(selected = false, onClick = {})
            AuraRadio(selected = true, onClick = {})
            AuraRadio(selected = true, onClick = {}, label = "Option A")
            AuraRadio(selected = false, onClick = {}, label = "Disabled", enabled = false)
        }
    }
}
