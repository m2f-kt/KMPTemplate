...
/**
 * An Aura-styled toggle switch component with accessibility support.
 *
 ...
 * between the off and on positions. Reads all styling from [AuraTheme].
 *
...
private fun AuraSwitchPreview() {
    AuraTheme {
        Column(
            ...
            AuraSwitch(checked = false, onCheckedChange = {})
            AuraSwitch(checked = true, onCheckedChange = {})
            AuraSwitch(checked = true, onCheckedChange = {}, label = "Dark mode")
            AuraSwitch(checked = false, onCheckedChange = {}, label = "Disabled", enabled = false)
        }
    }
}
