...
import com.m2f.server.ai.errors.DocumentAccessDenied
import com.m2f.server.ai.errors.DocumentNotFound
        ...
        post<Documents.Upload> {
            ...
            conduitAuth(HttpStatusCode.Created) { userId ->
                ...
                val ext = fileName.substringAfterLast('.', "").lowercase()
                    ...
                    com.m2f.server.ai.errors.DocumentIngestionFailed("Unsupported file type. Only .txt and .md files are supported.")
                }
