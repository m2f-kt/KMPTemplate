...
import com.m2f.server.files.contract.errors.FileTooLarge
import com.m2f.server.files.contract.errors.FileUploadFailed
import com.m2f.server.files.contract.errors.FileUnsupportedType
...
class S3FileService(
    ...
    override fun getPresignedUrl(fileKey: String): String =
