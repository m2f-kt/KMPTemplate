...
import com.m2f.server.groups.contract.errors.InvitationAlreadyAccepted
import com.m2f.server.groups.contract.errors.InvitationExpired
import com.m2f.server.groups.contract.errors.InvitationEmailMismatch
import com.m2f.server.groups.contract.errors.InvitationNotFound
import com.m2f.server.groups.contract.errors.InvitationRevoked
...
class InvitationServiceImpl(
     ...
     */
    context(raise: Raise<DomainError>)
    override suspend fun getInvitation(token: String): InvitationResponse {
