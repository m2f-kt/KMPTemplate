...
import template.composeapp.generated.resources.error_ai_agent_failed
import template.composeapp.generated.resources.error_ai_agent_not_found
import template.composeapp.generated.resources.error_ai_conversation_not_found
import template.composeapp.generated.resources.error_ai_provider_unavailable
import template.composeapp.generated.resources.error_auth_invalid_credentials
import template.composeapp.generated.resources.error_auth_token_expired
import template.composeapp.generated.resources.error_auth_token_invalid
import template.composeapp.generated.resources.error_auth_unauthorized
import template.composeapp.generated.resources.error_auth_user_already_exists
import template.composeapp.generated.resources.error_client_network_error
import template.composeapp.generated.resources.error_client_timeout
import template.composeapp.generated.resources.error_client_unknown_error
import template.composeapp.generated.resources.error_generic
import template.composeapp.generated.resources.error_group_already_exists
import template.composeapp.generated.resources.error_group_forbidden
import template.composeapp.generated.resources.error_group_member_already_exists
import template.composeapp.generated.resources.error_group_not_found
import template.composeapp.generated.resources.error_server_internal_error
import template.composeapp.generated.resources.error_server_service_unavailable
import template.composeapp.generated.resources.error_user_forbidden
import template.composeapp.generated.resources.error_user_not_found
import template.composeapp.generated.resources.error_validation_email_blank
import template.composeapp.generated.resources.error_validation_email_invalid
import template.composeapp.generated.resources.error_validation_field_required
import template.composeapp.generated.resources.error_validation_invalid_field
import template.composeapp.generated.resources.error_validation_invalid_input
import template.composeapp.generated.resources.error_validation_missing_field
import template.composeapp.generated.resources.error_validation_name_blank
...
import template.composeapp.generated.resources.error_invitation_already_accepted
import template.composeapp.generated.resources.error_invitation_expired
...
import template.composeapp.generated.resources.error_permission_denied
import template.composeapp.generated.resources.error_permission_restricted
import template.composeapp.generated.resources.error_permission_not_determined
import template.composeapp.generated.resources.error_native_unavailable
import template.composeapp.generated.resources.error_native_failure

/**
 * Composable bridge function that resolves a [StringKey] to its localized string.
 *
 * Uses an exhaustive `when` expression so that adding a new [StringKey] entry
 * causes a compile error until the mapping is added here.
 *
 * Named `resolveStringKey` (not `stringResource`) to avoid collision with
 * [org.jetbrains.compose.resources.stringResource].
 *
 * @param key The string key to resolve.
 * @param args Optional format arguments for parameterized strings.
 * @return The localized string for the current locale.
 */
@Composable
fun resolveStringKey(key: StringKey, vararg args: Any): String =
    when (key) {
        // Auth errors
